...
def repurpose(target, target_name = None, 
	...
	if X_repurpose is not None:
		...
		if not os.path.exists(os.path.join(save_dir, 'data_output')):
			os.mkdir(os.path.join(save_dir, 'data_output'))
		
		data_path = os.path.join(save_dir, 'data_output')
	...
	if train_drug is None:
		...
		# customized training data_output
		print('Training on your own customized data_output...')
